...
export function AirWavesIcon({
  className,
  variant = "navy",
}: IconProps & { variant?: "navy" | "cyan" | "white" | "dark" | "watermark" }) {
  const variants = {
    navy: "/images/logo-navy.png",
    cyan: "/images/logo-cyan.png",
...
interface ServiceIconProps extends IconProps {
  type: "blueprint" | "install" | "consult" | "maintenance" | "ventilation";
}

export function ServiceIcon({ type, className, style }: ServiceIconProps) {
  const icons = {
    blueprint: (
    ...
    maintenance: (
      <svg className={className} style={style} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
        <path d="M11 4a2 2 0 114 0v1a1 1 0 001 1h3a1 1 0 011 1v3a1 1 0 01-1 1h-1a2 2 0 100 4h1a1 1 0 011 1v3a1 1 0 01-1 1h-3a1 1 0 01-1-1v-1a2 2 0 10-4 0v1a1 1 0 01-1 1H6a1 1 0 01-1-1v-3a1 1 0 00-1-1H3a2 2 0 110-4h1a1 1 0 001-1V7a1 1 0 011-1h3a1 1 0 001-1V4z" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    ),
    ventilation: (
      <svg className={className} style={style} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
